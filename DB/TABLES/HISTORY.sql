  CREATE TABLE "HISTORY" 
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE, 
	...
	"ACTION_DATE" DATE DEFAULT SYSDATE NOT NULL ENABLE, 
	 CONSTRAINT "HISTORY_PK" PRIMARY KEY ("ID")
  USING INDEX  ENABLE
   ) ;

  ALTER TABLE "HISTORY" ADD CONSTRAINT "HISTORY_CON" FOREIGN KEY ("WISHBOOK_ID")
	  REFERENCES "WISHLIST_BOOKS" ("ID") ENABLE;
  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "HISTORY_CREATE_DATE" 
before
insert on "HISTORY"
for each row
begin
...
/
ALTER TRIGGER "HISTORY_CREATE_DATE" ENABLE;